...
if (count($_POST) > 0) {
    mysqli_query($con, "UPDATE `item_catagory` SET `name`='" . strtoupper($_POST["name1"]) . "',`manage_by`='" . $_POST["id1"] . "' WHERE id ='" . $_POST["id"] . "'");
    header("location:displayitemcatagory.php");
}
$result = mysqli_query($con, "SELECT * FROM `item_catagory` WHERE id ='" . $_GET["id"] . "'");
        ...
        <div class="container-fluid">
            <div class="container mt-3">
                ...
                <form name="" method="POST" action="">
                    ...
                    <input type="hidden" name="id1" value="<?php echo $user; ?>">
