...
$_result = mysqli_query($con,"SELECT * FROM `rms_order` WHERE order_date = CURRENT_DATE();");
...
<div class="col-md-3"><h3>Todays Order</h3></div>
<div class="col-md">
<a href="displaytodaysorder.php" class="btn btn-success" role="button" style="margin-left: 950px;" >Back</a></div></div></div>
 ...
 <div class="container-fluid">
        <div class="row g-3 my-2">
            ...
            <div class="col">
                <a href="displaytodaysorder.php" class="btn btn-success btn-lg-3" role="button" style="margin-left: 670px;">Back</a>
            </div>
        </div>
...
<?php
   ...
   <div class="container-fluid"><div class="alert alert-success" role="alert">
    ...
    <p>There is not any order placed yet.</p>
  </div></div>
<?php }
?>
</table>
