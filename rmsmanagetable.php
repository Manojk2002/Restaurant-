...
$_result = mysqli_query($con, "SELECT * FROM `rms_tables` order by id ");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <!-- <div class="container-fluid">    
        ...
        <div class="row g-3 my-2">
            ...
            <div class="col">
                <a href="rms_addtable.php" class="btn btn-success btn-lg-3" role="button" style="margin-left: 450px;">Add Table</a>
                <a href="index.php" class="btn btn-success ml-3" role="button">Back</a>
            </div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="updatetable.php?id=<?php echo $row["id"]; ?>" class="btn btn-success" role="button">Update</a>
                            </td>
                            <td></td>
