...
<body>
    ...
    <div class="row my-3 mx-3">
        ...
        <div class="col">
        <a href="adddiscount.php" class="btn btn-success ml-3" style="margin-left:370px ;" role="button">Add New Discount</a>
            ...
            <div class="container-fluid">
                <table class="table table-striped">
                    ...
                    while ($roww = mysqli_fetch_array($q)) {
                       $ai= $roww["manage by"];
                       $q1 = mysqli_query($con,"SELECT * FROM `rms_admin` WHERE id = $ai");
                       $r = mysqli_fetch_array($q1);
                    ?>
                        <tr>
                            <td><?php echo $roww["id"]; ?></td>
                            <td><?php echo $roww["name"]; ?></td>
                            <td><?php echo $roww["percentage"]; ?></td>
                            <td><?php echo $roww["purchese amount"]; ?></td>
                            <td><?php echo $r["name"]; ?></td>
                            <td><a href="updatediscount.php?id=<?php echo $roww["id"]; ?>" class="btn btn-success" role="button">Update</a>
