...
if (isset($_POST['submit'])) {
  $jn = strtoupper($_POST['role']);
  $sal = $_POST['salary'];
  $sql = "INSERT INTO `rms_jobrole`(`name`, `salary`) VALUES ('$jn','$sal')";
  $q = mysqli_query($con, $sql);
  if ($q > 0) {
?> <div class="alert alert-warning alert-dismissible fade show" role="alert">
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
<?php echo "Job Role Added Successfully"; ?><br>
</div>
<?php
  } else {
    ?> 
...
<div class="container mt-3">
  ...
  <form action="" method="POST">
    ...
    <div class="mb-3 mt-3">
      ...
      <input type="text" class="form-control" id="item" placeholder="Enter Job Role" name="role" required>
    </div>
    <div class="mb-3 mt-3">
      <label for="item">Salary:</label>
      <input type="number" class="form-control" id="item" placeholder="Enter Salary" name="salary" required>
    </div>
