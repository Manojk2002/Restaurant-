...
if (isset($_POST['submit'])) {
    ...
    header("location:orderselectcatagori.php");
}
                    ...
                    <div class="container-fluid mt-3">
                        ...
                        <form action="" method="POST">
                            ...
                            <!-- <div class="row">
                                ...
                                <input type="submit" class="btn btn-success col-lg-2 " name="submit" value="SELECT" style="margin-left:260px ;">

                        </form>
                        <div class="form-group">
                            <a href="displaytodaysorder.php" class="btn btn-success col-lg-2 mt-2">Back</a>
                        </div> -->
<!--  -->
                        ...
                        <div class="row" style="margin-left:30px ;">
                             ...
                             <a style="margin-left:100px ;" href="displaytodaysorder.php" class="btn btn-success col-lg-2 mt-3" role="button">Back</a>
                         </div>
                         </form>
